...
public class ProductController {
    ...
    public String toProductPage(int id, Map<String, Object> map) {
        ...
        return "priv/jssse/mall/product/info";
    }
    ...
    @ResponseBody
    @RequestMapping(method = RequestMethod.GET,value = "/findByTitle.do")
    public ResultBean<List<Product>> findByTitleIsLike(String keyword,int pageNo, int pageSize){
        Pageable pageable = new PageRequest(pageNo, pageSize);
        List<Product> byTitleIsLike = productService.findByTitleIsLike(keyword,pageable);
        return  new ResultBean<>(byTitleIsLike);
    }
    ...
    public String toCatePage(int cid, Map<String, Object> map) {
        ...
        return "priv/jssse/mall/product/category";
    }

    @RequestMapping("/toCart.html")
    public String toCart(){
        return "priv/jssse/mall/product/cart";
    }
